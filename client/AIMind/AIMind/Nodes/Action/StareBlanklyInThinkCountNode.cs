...
namespace AIMind.Nodes
{
    public class StareBlanklyInThinkCountNode : Action
    {
        ...
        protected override void CloneProperties(Node newnode)
        {
            ...
            StareBlanklyInThinkCountNode node = (StareBlanklyInThinkCountNode)newnode;
            node.ThinkCount = thinkCount;
        }

        public StareBlanklyInThinkCountNode() : base("发呆并跳过思考", "") { }
#else
        ...
        {
            return theOwner.StareBlanklyInThinkCount(thinkCount);
        }
#endif
    }
}

...
public abstract class UIBuilder
{
    ...
    {
        rootGameObject = go;
        childrenTransform = go.GetComponentsInChildren<Transform>();
    }
    ...
    protected virtual string GetClassName()
    {
        ...
        {
            return rootGameObject.name + "UICtrl";
        }
        return "";
    }
...
public class CSharpUIBuilder : UIBuilder
{
    ...
    {
        SetSavePath("Script/UI/Generate");
        SetTemplatePath(Path.Combine(Application.dataPath, "Editor/GenUITools/UITemplate/C#_UI_Template.txt"));
        SetFileSuffix(".cs");
...
public class LuaUIBuilder : UIBuilder
{
    ...
    {
        SetSavePath("ResourcesEx/Lua/UI/Generate");
        SetTemplatePath(Path.Combine(Application.dataPath, "Editor/GenUITools/UITemplate/Lua_UI_Template.txt"));
        SetFileSuffix(".lua");
        SetComponentInfo(new UGUIComponentInfo());
    }

...
#pragma warning disable 0414
    ...
    static private EventDispatcherHelper messengerHelper = (new GameObject("MessengerHelper")).AddComponent<EventDispatcherHelper>();
#pragma warning restore 0414
    ...
    static public void Cleanup()
    {
        ...
        foreach (KeyValuePair<string, Delegate> pair in eventTable)
        {
            ...
            for (int index = 0; index < permanentMessages.Count; ++index)
            {
                if (pair.Key == permanentMessages[index])
                {
                    wasFound = true;
                    break;
                }
        ...
        {
            eventTable.Remove(messagesToRemove[index]);
        }
    }
    ...
    static public void PrintEventTable()
    {
        ...
        foreach (KeyValuePair<string, Delegate> pair in eventTable)
        {
            Debug.Log(string.Concat("\t\t\t", pair.Key, "\t\t" + pair.Value));
        }
    ...
    static public void BroadcastAsync(string eventType)
    {
        ...
        messengerHelper.GetComponent<EventDispatcherHelper>().AddTask(ac);
    }
